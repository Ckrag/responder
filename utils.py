...
class Util(object):
    ...
    def get_source_content():
        ...
        if os.path.isfile(local_path + "/" + source_filename):
            with open(local_path + "/" + source_filename) as source_data:
            ...
            with open(template_path + source_template_filename, 'r') as template:
                ...
                with open(local_path + "/" + source_filename, 'w') as new_source_file:
